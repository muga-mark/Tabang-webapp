...
class Profile extends Component{
    ...
    //         this.setState({emailVerified: this.state.isEmailVerified});
    //         console.log('isEmailVerified2: ', this.state.isEmailVerified);
    //     }
    // }
            ...
            <div>
                ...
                <div className="Profilepage">
                    ...
                    <div className='login-form'>
                        {/* <Segment style={{color:'whitesmoke', fontSize:'30px'}}><b>PROFILE</b></Segment> */}
                        ...
                        {/* <Segment style={{paddingBottom:'75px'}}> */}
                            <div style={{color:'whitesmoke', fontSize:'16px', marginBottom:'50px'}}>
                                ...
                                {/* <p><b style={{fontSize:'20px'}}>Password: </b> {this.state.password} </p> */}
                            </div>
                        {/* </Segment> */}
                        {/* <Segment style={{paddingBTop:'20px'}}> */}
